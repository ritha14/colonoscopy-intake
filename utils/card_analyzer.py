...
- medicare              (Original Medicare Part A/B issued by CMS — red/white/blue card)
- ppo                   (any PPO plan — eligible via No Surprises Act / IDR)
- hmo                   (HMO or EPO — no out-of-network benefits)
- medicare_advantage    (any Medicare Advantage plan)
- medicaid              (Medicaid or Medicaid managed care)
- unknown               (cannot determine from card)

When in doubt between ppo and unknown, choose ppo if you can see "PPO" anywhere on the card.
Tricare → use unknown (office will verify).
VA/CHAMPVA → use unknown (office will verify).
"""
